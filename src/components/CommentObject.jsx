  ...
  return (
    <div
      className="
        ...
        mx-auto pt-5 pb-5 
        px-3 sm:px-5   /* horizontal padding */
        my-3 sm:my-4   /* vertical margin */
    ...
    >
      <div>
        <div className="flex items-center gap-x-2">
          <div
            className="rounded-full w-10 h-10 flex items-center justify-center text-xl font-outfit text-white font-extralight"
            style={{
