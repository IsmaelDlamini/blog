      ...
      <div className="w-full pt-16 ">
        ...
        <div className=" w-[1000px] mx-auto">
          ...
          <div className="w-full my-8">
            <button className="bg-customTeal px-6 py-2 text-white text-sm font-outfit font-extralight border-none outline-none">See More</button>
          </div>
        </div>
        ...
        <div className="w-2/4 space-y-5 flex flex-col justify-center">
            ...
            <p className="text-white font-extralight text-lg ">Have the wish to join the team? </p>
